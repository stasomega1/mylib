...
The packages of interest are github.com/stasomega1/mylib/document,
unidoc/unioffice/spreadsheet and github.com/stasomega1/mylib/presentation.
...
func _gbe(_bab []*any) []*XSDAny {
	_gbef := []*XSDAny{}
	for _, _fggg := range _bab {
		_dce := &XSDAny{}
		_dce.XMLName = _fggg.XMLName
		_dce.Attrs = _fggg.Attrs
		_dce.Data = _fggg.Data
		_dce.Nodes = _gbe(_fggg.Nodes)
		_gbef = append(_gbef, _dce)
	}
	return _gbef
}
func (_eag nsSet) applyToNode(_ec *any) {
	if _ec.XMLName.Space == "" {
		return
	}
	_gf := _eag.getPrefix(_ec.XMLName.Space)
	_ec.XMLName.Space = ""
	_ec.XMLName.Local = _gf + "\u003a" + _ec.XMLName.Local
	_gcd := _ec.Attrs
	_ec.Attrs = nil
	for _, _agc := range _gcd {
		if _agc.Name.Space == "\u0078\u006d\u006cn\u0073" {
			continue
		}
		if _agc.Name.Space != "" {
			_ccc := _eag.getPrefix(_agc.Name.Space)
			_agc.Name.Space = ""
			_agc.Name.Local = _ccc + "\u003a" + _agc.Name.Local
		}
		_ec.Attrs = append(_ec.Attrs, _agc)
	}
	for _, _eeb := range _ec.Nodes {
		_eag.applyToNode(_eeb)
	}
}

// MarshalXML implements the xml.Marshaler interface.
func (_ggf *XSDAny) MarshalXML(e *_c.Encoder, start _c.StartElement) error {
	start.Name = _ggf.XMLName
	start.Attr = _ggf.Attrs
	_dgg := any{}
	_dgg.XMLName = _ggf.XMLName
	_dgg.Attrs = _ggf.Attrs
	_dgg.Data = _ggf.Data
	_dgg.Nodes = _bdd(_ggf.Nodes)
	_gcec := []string{}
	_fda := false
	_dfd := nsSet{_gce: map[string]string{}, _cd: map[string]string{}}
	_ggf.collectNS(&_dfd)
	_dfd.applyToNode(&_dgg)
	for _, _feb := range _dfd._af {
		if _, _fga := _cae[_feb]; _fga {
			_gcec = append(_gcec, _feb)
		}
		_dbbd := _dfd._cd[_feb]
		_dgg.Attrs = append(_dgg.Attrs, _c.Attr{Name: _c.Name{Local: "\u0078\u006d\u006c\u006e\u0073\u003a" + _feb}, Value: _dbbd})
		if _feb == "\u006d\u0063" {
			_fda = true
		}
	}
	if _fda && len(_gcec) > 0 {
		_dgg.Attrs = append(_dgg.Attrs, _c.Attr{Name: _c.Name{Local: "\u006d\u0063\u003aI\u0067\u006e\u006f\u0072\u0061\u0062\u006c\u0065"}, Value: _aa.Join(_gcec, "\u0020")})
	}
	return e.Encode(&_dgg)
}
...
func RelativeFilename(dt DocType, relToTyp, typ string, index int) string {
	_ag := AbsoluteFilename(dt, typ, index)
	if relToTyp == "" {
		return _ag
	}
	_agg := AbsoluteFilename(dt, relToTyp, index)
	_fg := _aa.Split(_agg, "\u002f")
	_ba := _aa.Split(_ag, "\u002f")
	_ac := 0
	for _bb := 0; _bb < len(_fg); _bb++ {
		if _fg[_bb] == _ba[_bb] {
			_ac++
		}
		if _bb+1 == len(_ba) {
	...
	_cb := len(_fg) - 1
	if _cb > 0 {
		return _bd.RepeatString("\u002e\u002e\u002f", _cb) + _aa.Join(_ba, "\u002f")
	}
	return _aa.Join(_ba, "\u002f")
}
...
func RelativeImageFilename(dt DocType, relToTyp, typ string, index int, fileExtension string) string {
	_bbg := RelativeFilename(dt, relToTyp, typ, index)
	return _bbg[0:len(_bbg)-3] + fileExtension
}
...
func Int64(v int64) *int64 { _gc := v; return &_gc }
...
func CreateElement(start _c.StartElement) (Any, error) {
	_df, _ccg := _fc[start.Name.Space+"\u002f"+start.Name.Local]
	if !_ccg {
		_bc := &XSDAny{}
		return _bc, nil
	}
	...
	_aac := _g.Call(nil)
	if len(_aac) != 1 {
		return nil, _d.Errorf("\u0063\u006fn\u0073\u0074\u0072\u0075\u0063t\u006f\u0072\u0020\u0066\u0075n\u0063\u0074\u0069\u006f\u006e\u0020\u0073\u0068\u006f\u0075\u006c\u0064\u0020\u0072\u0065\u0074\u0075\u0072\u006e\u0020\u006f\u006e\u0065\u0020\u0076\u0061\u006c\u0075\u0065\u002c\u0020\u0067\u006f\u0074\u0020\u0025\u0064", len(_aac))
	}
	_gg, _ccg := _aac[0].Interface().(Any)
	if !_ccg {
		return nil, _cc.New("\u0063o\u006e\u0073t\u0072\u0075\u0063\u0074o\u0072\u0020\u0066u\u006e\u0063\u0074\u0069\u006f\u006e\u0020\u0073\u0068ou\u006c\u0064\u0020r\u0065\u0074u\u0072\u006e\u0020\u0061\u006e\u0079 \u0027\u0041n\u0079\u0027")
	}
	return _gg, nil
}
...
func AbsoluteImageFilename(dt DocType, index int, fileExtension string) string {
	_fge := AbsoluteFilename(dt, ImageType, index)
	return _fge[0:len(_fge)-3] + fileExtension
}

var _cae = map[string]bool{"\u0077\u0031\u0030": true, "\u0077\u0031\u0034": true, "\u0077\u0070\u0031\u0034": true, "\u0077\u0031\u0035": true, "\u0078\u0031\u0035a\u0063": true, "\u0077\u0031\u0036s\u0065": true, "\u0077\u0031\u0036\u0063\u0069\u0064": true, "\u0077\u0031\u0036": true, "\u0077\u0031\u0036\u0063\u0065\u0078": true}
...
func (_eaa *XSDAny) UnmarshalXML(d *_c.Decoder, start _c.StartElement) error {
	_dfea := any{}
	if _bf := d.DecodeElement(&_dfea, &start); _bf != nil {
		return _bf
	}
	_ccd(&_dfea)
	_eaa.XMLName = _dfea.XMLName
	_eaa.Attrs = _dfea.Attrs
	_eaa.Data = _dfea.Data
	_eaa.Nodes = _gbe(_dfea.Nodes)
	return nil
}
...
type nsSet struct {
	_gce map[string]string
	_cd  map[string]string
	_af  []string
}

var _fc = map[string]interface{}{}

// Uint32 returns a copy of v as a pointer.
func Uint32(v uint32) *uint32 { _ee := v; return &_ee }
func (_fcd *XSDAny) collectNS(_ed *nsSet) {
	if _fcd.XMLName.Space != "" {
		_ed.getPrefix(_fcd.XMLName.Space)
	}
	for _, _cbg := range _fcd.Attrs {
		if _cbg.Name.Space != "" && _cbg.Name.Space != "\u0078\u006d\u006cn\u0073" {
			_ed.getPrefix(_cbg.Name.Space)
		}
	}
	for _, _ccf := range _fcd.Nodes {
		_ccf.collectNS(_ed)
	}
}
...
type Any interface {
	MarshalXML(_f *_c.Encoder, _ce _c.StartElement) error
	UnmarshalXML(_bg *_c.Decoder, _fe _c.StartElement) error
}

func (_dg *nsSet) getPrefix(_gd string) string {
	if _acd, _eed := _cfc[_gd]; _eed {
		if _, _db := _dg._cd[_acd]; !_db {
			_dg._cd[_acd] = _gd
			_dg._gce[_gd] = _acd
			_dg._af = append(_dg._af, _acd)
		}
		return _acd
	}
	_gd = _aa.TrimFunc(_gd, func(_gde rune) bool { return !_ca.IsLetter(_gde) })
	if _afe, _dbe := _dg._gce[_gd]; _dbe {
		return _afe
	}
	_bfd := _aa.Split(_gd, "\u002f")
	_bfd = _aa.Split(_bfd[len(_bfd)-1], "\u003a")
	_fbc := _bfd[len(_bfd)-1]
	_gdf := 0
	_afg := []byte{}
	for {
		if _gdf < len(_fbc) {
			_afg = append(_afg, _fbc[_gdf])
		} else {
			_afg = append(_afg, '_')
		}
		_gdf++
		if _, _agge := _dg._cd[string(_afg)]; !_agge {
			_dg._cd[string(_afg)] = _gd
			_dg._gce[_gd] = string(_afg)
			_dg._af = append(_dg._af, string(_afg))
			return string(_afg)
		}
	}
}
...
func Uint8(v uint8) *uint8 { _fgg := v; return &_fgg }

var _cfc = func() map[string]string {
	_dfe := map[string]string{}
	for _cfg, _ga := range _fbg {
		_dfe[_ga] = _cfg
	}
	return _dfe
}()

func _bdd(_gcb []*XSDAny) []*any {
	_be := []*any{}
	for _, _ded := range _gcb {
		_bbb := &any{}
		_bbb.XMLName = _ded.XMLName
		_eea := []_c.Attr{}
		for _, _caa := range _ded.Attrs {
			if _caa.Name.Local != "\u0078\u006d\u006cn\u0073" {
				_eea = append(_eea, _caa)
			}
		}
		_bbb.Attrs = _eea
		_bbb.Data = _ded.Data
		_bbb.Nodes = _bdd(_ded.Nodes)
		_be = append(_be, _bbb)
	}
	return _be
}
...
func AddPreserveSpaceAttr(se *_c.StartElement, s string) {
	if NeedsSpacePreserve(s) {
		se.Attr = append(se.Attr, _c.Attr{Name: _c.Name{Local: "\u0078m\u006c\u003a\u0073\u0070\u0061\u0063e"}, Value: "\u0070\u0072\u0065\u0073\u0065\u0072\u0076\u0065"})
	}
}
...
func AbsoluteFilename(dt DocType, typ string, index int) string {
	...
	case CustomXMLType:
		return _d.Sprintf("c\u0075s\u0074\u006f\u006d\u0058\u006d\u006c\u002f\u0069t\u0065\u006d\u0025\u0064.x\u006d\u006c", index)
	...
	case ThemeType, ThemeTypeStrict, ThemeContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _d.Sprintf("x\u006c/\u0074\u0068\u0065\u006d\u0065\u002f\u0074\u0068e\u006d\u0065\u0025\u0064.x\u006d\u006c", index)
		case DocTypeDocument:
			return _d.Sprintf("\u0077\u006f\u0072\u0064/t\u0068\u0065\u006d\u0065\u002f\u0074\u0068\u0065\u006d\u0065\u0025\u0064\u002e\u0078m\u006c", index)
		case DocTypePresentation:
			return _d.Sprintf("p\u0070\u0074\u002f\u0074he\u006de\u002f\u0074\u0068\u0065\u006de\u0025\u0064\u002e\u0078\u006d\u006c", index)
		default:
			Log("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	...
	case ChartType, ChartTypeStrict, ChartContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _d.Sprintf("x\u006c\u002f\u0063\u0068ar\u0074s\u002f\u0063\u0068\u0061\u0072t\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypeDocument:
			return _d.Sprintf("\u0077\u006f\u0072d/\u0063\u0068\u0061\u0072\u0074\u0073\u002f\u0063\u0068\u0061\u0072\u0074\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypePresentation:
			return _d.Sprintf("\u0070\u0070\u0074\u002fch\u0061\u0072\u0074\u0073\u002f\u0063\u0068\u0061\u0072\u0074\u0025\u0064\u002e\u0078m\u006c", index)
		default:
			Log("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case TableType, TableTypeStrict, TableContentType:
		return _d.Sprintf("x\u006c\u002f\u0074\u0061bl\u0065s\u002f\u0074\u0061\u0062\u006ce\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case DrawingType, DrawingTypeStrict, DrawingContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _d.Sprintf("\u0078l\u002f\u0064\u0072\u0061w\u0069\u006e\u0067\u0073\u002fd\u0072a\u0077i\u006e\u0067\u0025\u0064\u002e\u0078\u006dl", index)
		default:
			Log("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case CommentsType, CommentsTypeStrict, CommentsContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _d.Sprintf("\u0078\u006c\u002f\u0063\u006f\u006d\u006d\u0065\u006e\u0074\u0073\u0025d\u002e\u0078\u006d\u006c", index)
		default:
			Log("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case VMLDrawingType, VMLDrawingTypeStrict, VMLDrawingContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _d.Sprintf("\u0078\u006c\u002f\u0064r\u0061\u0077\u0069\u006e\u0067\u0073\u002f\u0076\u006d\u006cD\u0072a\u0077\u0069\u006e\u0067\u0025\u0064\u002ev\u006d\u006c", index)
		default:
			Log("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case ImageType, ImageTypeStrict:
		switch dt {
		case DocTypeDocument:
			return _d.Sprintf("\u0077\u006f\u0072\u0064/m\u0065\u0064\u0069\u0061\u002f\u0069\u006d\u0061\u0067\u0065\u0025\u0064\u002e\u0070n\u0067", index)
		case DocTypeSpreadsheet:
			return _d.Sprintf("x\u006c/\u006d\u0065\u0064\u0069\u0061\u002f\u0069\u006da\u0067\u0065\u0025\u0064.p\u006e\u0067", index)
		case DocTypePresentation:
			return _d.Sprintf("p\u0070\u0074\u002f\u006ded\u0069a\u002f\u0069\u006d\u0061\u0067e\u0025\u0064\u002e\u0070\u006e\u0067", index)
		default:
			Log("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case WorksheetType, WorksheetTypeStrict, WorksheetContentType:
		return _d.Sprintf("\u0078l\u002f\u0077\u006f\u0072k\u0073\u0068\u0065\u0065\u0074s\u002fs\u0068e\u0065\u0074\u0025\u0064\u002e\u0078\u006dl", index)
	...
	case HeaderType, HeaderTypeStrict:
		return _d.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0068\u0065\u0061\u0064\u0065\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case FooterType, FooterTypeStrict:
		return _d.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0066\u006f\u006f\u0074\u0065\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case SlideType, SlideTypeStrict:
		return _d.Sprintf("\u0070\u0070\u0074\u002fsl\u0069\u0064\u0065\u0073\u002f\u0073\u006c\u0069\u0064\u0065\u0025\u0064\u002e\u0078m\u006c", index)
	case SlideLayoutType:
		return _d.Sprintf("\u0070\u0070\u0074/s\u006c\u0069\u0064\u0065\u004c\u0061\u0079\u006f\u0075t\u0073/\u0073l\u0069d\u0065\u004c\u0061\u0079\u006f\u0075\u0074\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case SlideMasterType:
		return _d.Sprintf("\u0070\u0070\u0074/s\u006c\u0069\u0064\u0065\u004d\u0061\u0073\u0074\u0065r\u0073/\u0073l\u0069d\u0065\u004d\u0061\u0073\u0074\u0065\u0072\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case HandoutMasterType:
		return _d.Sprintf("\u0070\u0070\u0074\u002f\u0068\u0061\u006e\u0064\u006f\u0075\u0074\u004d\u0061\u0073\u0074\u0065\u0072\u0073\u002f\u0068\u0061\u006e\u0064\u006fu\u0074\u004d\u0061\u0073\u0074e\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case NotesMasterType:
		return _d.Sprintf("\u0070\u0070\u0074/n\u006f\u0074\u0065\u0073\u004d\u0061\u0073\u0074\u0065r\u0073/\u006eo\u0074e\u0073\u004d\u0061\u0073\u0074\u0065\u0072\u0025\u0064\u002e\u0078\u006d\u006c", index)
	default:
