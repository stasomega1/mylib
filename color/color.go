...
func (_cfa Color) AsRGBAString() *string {
	return _fg.Stringf("\u0025\u00302\u0078\u0025\u00302\u0078\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _cfa._a, _cfa._be, _cfa._fe, _cfa._c)
}
...
func FromHex(s string) Color {
	...
	var _g, _fc, _fgd uint8
	_bb, _ := _b.Sscanf(s, "\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", &_g, &_fc, &_fgd)
	if _bb == 3 {
		return RGB(_g, _fc, _fgd)
	}
	return Auto
}
...
// to a string containing a six digit hex RGB value.
func (_fgg Color) AsRGBString() *string {
	return _fg.Stringf("\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _fgg._be, _fgg._fe, _fgg._c)
}
...
func (_ab Color) IsAuto() bool { return _ab._cf }
